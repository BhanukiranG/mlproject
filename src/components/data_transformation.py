...
#     preprocessor_ob_file_path=os.path.join('artifacts',"preprocessor.pkl") #pickle file serializes the wide range of objects
...
#                 ("scalar",StandardScaler()) #scaling the no.s
#                 ]
#             )
#             #for categorical
